...
public class GsonUtilEjemplo {
    ...
    public static void main(String[] args) {
        GsonSoloLectura.Usuario usuario = new GsonSoloLectura.Usuario("Juan", 89, "juan@example.com");
        String rutaArchivo = "usuario.json";
        guardarObjetoEnArchivo(rutaArchivo, usuario);
        GsonSoloLectura.Usuario usuarioCargado = cargarObjetoDesdeArchivo(rutaArchivo, GsonSoloLectura.Usuario.class);
